<x-app-layout>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-position-type-table-toolbar="base">
                                ...
                                <!--begin::Import-->
                                <button type="button" class="btn btn-sm btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_import_position_type">
    ...
    @push('modal')
        ...
        <!--begin::Modal - Position Type  - Import-->
        <div class="modal fade" id="kt_modal_import_position_type" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="fw-bold">Import Position Type</h2>
                        <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-position-type-modal-action="close">
                            <i class="ki-duotone ki-cross fs-1">
                                <span class="path1"></span>
                                <span class="path2"></span>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <form id="kt_modal_import_position-type_form" class="form" action="{{ route('masterDataPositionType.importPositionType') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="fv-row mb-10">
                            ...
                            <div class="text-center">
                                <a href="{{ route('masterDataPositionType.templateImport') }}" class="btn btn-sm btn-success">Template</a>
                                <button type="reset" class="btn btn-light me-3" data-kt-position-type-modal-action="cancel">Discard</button>
                                <button type="submit" class="btn btn-primary" data-kt-position-type-modal-action="submit">
                                    <span class="indicator-label">Submit</span>
                                    <span class="indicator-progress">Please wait...
