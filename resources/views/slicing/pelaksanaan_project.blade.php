    ...
    <div class="card" style="min-height: 400px;">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-3" data-kt-user-table-toolbar="base">
                <a href="{{ route('slicing') }}?nama_blade=tambah_project_pelaksanaan" class="btn btn-sm btn-primary">
                    Tambah Proyek
                </a>
            </div>
                ...
                <table id="kt_datatable_fixed_columns" class="table table-striped table-row-bordered gy-5 gs-7">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>01 Jan 2024</td>
                            <td><span class="badge badge-light-primary">Pelaksanaan</span></td>
                            <td class="actions">
                                <div class="dropdown dropdown-inline mr-4">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('slicing') }}?nama_blade=tambah_project_pelaksanaan">Ubah Project</a></li>
                                        <li><a class="dropdown-item" href="{{ route('slicing') }}?nama_blade=detail_project_pelaksanaan.ringkasan">Detail Project</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
