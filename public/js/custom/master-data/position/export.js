...
// Class definition
var KTModalExportPositions = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_position');
    const form = element.querySelector('#kt_modal_export_position_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Position Sudah berhasil di export!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-position-modal-action="cancel"]');
