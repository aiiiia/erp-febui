...
// Class definition
var KTUsersAddPosition = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_position');
    const form = element.querySelector('#kt_modal_add_position_form');
