...
// Class definition
var KTUsersAddPelatihan = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_pelatihan');
    const form = element.querySelector('#kt_modal_add_pelatihan_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddPelatihan = () => {
