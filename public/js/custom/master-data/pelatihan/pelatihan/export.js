...
// Class definition
var KTModalExportPelatihans = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_pelatihan');
    const form = element.querySelector('#kt_modal_export_pelatihan_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Pelatihan Sudah berhasil di export!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-pelatihan-modal-action="cancel"]');
