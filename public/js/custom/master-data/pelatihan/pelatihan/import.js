...
// Class definition
var KTModalImportPelatihans = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_pelatihan');
    const form = element.querySelector('#kt_modal_import_pelatihan_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Pelatihan Sudah berhasil di import!",
                                icon: "success",
