...
// Class definition
var KTModalExportPelatihanKelompoks = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_pelatihan_kelompok');
    const form = element.querySelector('#kt_modal_export_pelatihan_kelompok_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Pelatihan Kelompok Sudah berhasil di export!",
                                icon: "success",
...
KTUtil.onDOMContentLoaded(function () {
    KTModalExportPelatihanKelompoks.init();
});
