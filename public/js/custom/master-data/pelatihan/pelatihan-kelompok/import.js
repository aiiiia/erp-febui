...
// Class definition
var KTModalImportPelatihanKelompoks = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_pelatihan_kelompok');
    const form = element.querySelector('#kt_modal_import_pelatihan_kelompok_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Pelatihan Kelompok Sudah berhasil di import!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-pelatihan-kelompok-modal-action="cancel"]');
...
KTUtil.onDOMContentLoaded(function () {
    KTModalImportPelatihanKelompoks.init();
});
