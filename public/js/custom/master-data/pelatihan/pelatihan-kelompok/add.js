...
// Class definition
var KTUsersAddPelatihanKelompok = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_pelatihan_kelompok');
    const form = element.querySelector('#kt_modal_add_pelatihan_kelompok_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddPelatihanKelompok = () => {
...
KTUtil.onDOMContentLoaded(function () {
    KTUsersAddPelatihanKelompok.init();
});
