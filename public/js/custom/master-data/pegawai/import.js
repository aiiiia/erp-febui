...
var KTModalImportClients = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_pegawai_type');
    const form = element.querySelector('#kt_modal_import_pegawai_type_form');
    ...
    var initForm = function () {
        ...
        const submitButton = element.querySelector('[data-kt-pegawai-type-modal-action="submit"]');
        ...
        const cancelButton = element.querySelector('[data-kt-pegawai-type-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[data-kt-pegawai-type-modal-action="close"]');
