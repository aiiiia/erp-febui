...
// Class definition
var KTModalExportPegawais = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_pegawai');
    const form = element.querySelector('#kt_modal_export_pegawai_form');
    ...
    var initForm = function () {
        ...
        const cancelButton = element.querySelector('[data-kt-pegawai-modal-action="cancel"]');
