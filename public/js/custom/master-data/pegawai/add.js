...
// Class definition
var KTUsersAddPegawai = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_pegawai');
    const form = element.querySelector('#kt_modal_add_pegawai_form');
