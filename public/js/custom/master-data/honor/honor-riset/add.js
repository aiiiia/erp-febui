...
// Class definition
var KTUsersAddHonorRiset = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_honor-riset');
    const form = element.querySelector('#kt_modal_add_honor-riset_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddHonorRiset = () => {
        ...
        const cancelButton = element.querySelector('[data-kt-honor-riset-modal-action="cancel"]');
