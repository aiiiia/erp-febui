...
// Class definition
var KTUsersAddHonorAsesmen = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_honor-asesmen');
    const form = element.querySelector('#kt_modal_add_honor-asesmen_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddHonorAsesmen = () => {
