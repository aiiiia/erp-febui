...
var KTModalExportClients = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_honor-asesmen');
    const form = element.querySelector('#kt_modal_export_honor-asesmen_form');
    ...
    var initForm = function () {
        ...
        const cancelButton = element.querySelector('[data-kt-honor-asesmen-modal-action="cancel"]');
