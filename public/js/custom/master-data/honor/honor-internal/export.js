...
// Class definition
var KTModalExportClients = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_honor-internal');
    const form = element.querySelector('#kt_modal_export_honor-internal_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Client Sudah berhasil di export!",
                                icon: "success",
