...
// Class definition
var KTUsersAddHonorInternal = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_honor-internal');
    const form = element.querySelector('#kt_modal_add_honor-internal_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddHonorInternal = () => {
        ...
        const cancelButton = element.querySelector('[data-kt-honor-internal-modal-action="cancel"]');
