...
// Class definition
var KTUsersAddClientJenis = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_client_jenis');
    const form = element.querySelector('#kt_modal_add_client_jenis_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddClientJenis = () => {
