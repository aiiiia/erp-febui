...
// Class definition
var KTModalExportClientJeniss = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_client_jenis');
    const form = element.querySelector('#kt_modal_export_client_jenis_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Jenis Klien Sudah berhasil di export!",
                                icon: "success",
...
KTUtil.onDOMContentLoaded(function () {
    KTModalExportClientJeniss.init();
});
