...
// Class definition
var KTModalImportClientJeniss = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_client_jenis');
    const form = element.querySelector('#kt_modal_import_client_jenis_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Jenis Klien Sudah berhasil di import!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-client-jenis-modal-action="cancel"]');
...
KTUtil.onDOMContentLoaded(function () {
    KTModalImportClientJeniss.init();
});
