...
// Class definition
var KTModalExportClientSumberDanas = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_client_sumber_dana');
    const form = element.querySelector('#kt_modal_export_client_sumber_dana_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Sumber Dana Klien Sudah berhasil di export!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-client-sumber-dana-modal-action="cancel"]');
...
KTUtil.onDOMContentLoaded(function () {
    KTModalExportClientSumberDanas.init();
});
