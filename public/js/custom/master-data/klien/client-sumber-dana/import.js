...
// Class definition
var KTModalImportClientSumberDanas = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_client_sumber_dana');
    const form = element.querySelector('#kt_modal_import_client_sumber_dana_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Sumber Dana Klien Sudah berhasil di import!",
                                icon: "success",
...
KTUtil.onDOMContentLoaded(function () {
    KTModalImportClientSumberDanas.init();
});
