...
// Class definition
var KTUsersAddClientSumberDana = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_client_sumber_dana');
    const form = element.querySelector('#kt_modal_add_client_sumber_dana_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddClientSumberDana = () => {
...
KTUtil.onDOMContentLoaded(function () {
    KTUsersAddClientSumberDana.init();
});
