...
// Class definition
var KTModalExportIndustris = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_industri');
    const form = element.querySelector('#kt_modal_export_industri_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Industri Sudah berhasil di export!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-industri-modal-action="cancel"]');
