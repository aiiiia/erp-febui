...
// Class definition
var KTUsersAddIndustri = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_industri');
    const form = element.querySelector('#kt_modal_add_industri_form');
