...
// Class definition
var KTModalImportIndustris = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_industri');
    const form = element.querySelector('#kt_modal_import_industri_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Industri Sudah berhasil di import!",
                                icon: "success",
