...
// Class definition
var KTModalExportUnits = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_unit');
    const form = element.querySelector('#kt_modal_export_unit_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Unit Sudah berhasil di export!",
                                icon: "success",
