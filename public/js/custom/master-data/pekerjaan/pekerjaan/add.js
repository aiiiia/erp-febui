...
// Class definition
var KTUsersAddPekerjaan = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_pekerjaan');
    const form = element.querySelector('#kt_modal_add_pekerjaan_form');
    const modal = new bootstrap.Modal(element);

    // Init add schedule modal
    var initAddPekerjaan = () => {
