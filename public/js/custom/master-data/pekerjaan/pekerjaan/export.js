...
// Class definition
var KTModalExportPekerjaans = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_pekerjaan');
    const form = element.querySelector('#kt_modal_export_pekerjaan_form');
    ...
    var initForm = function () {
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Pekerjaan Sudah berhasil di export!",
                                icon: "success",
        ...
        const cancelButton = element.querySelector('[data-kt-pekerjaan-modal-action="cancel"]');
