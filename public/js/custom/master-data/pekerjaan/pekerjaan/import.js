...
// Class definition
var KTModalImportPekerjaans = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_pekerjaan');
    const form = element.querySelector('#kt_modal_import_pekerjaan_form');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "Daftar Pekerjaan Sudah berhasil di import!",
                                icon: "success",
