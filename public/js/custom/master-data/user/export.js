...
var KTModalExportUsers = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_user');
    const form = element.querySelector('#kt_modal_export_user_form');
    ...
    var initForm = function () {
        ...
        const cancelButton = element.querySelector('[data-kt-user-modal-action="cancel"]');
