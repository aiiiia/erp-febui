...
class ClientLokasiImport implements ToCollection, SkipsEmptyRows, WithStartRow, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function collection(Collection $collection)
    {
        ...
        if (
            $data_import['id'] == 'Contoh ID Lokasi Client' &&
            $data_import['nama'] == 'Contoh Nama Lokasi Client'
        ) {
        ...
        foreach ($collection as $value) {
            $client = RefClientLokasi::find($value['id']);
