...
class PelatihanImport implements ToCollection, SkipsEmptyRows, WithStartRow, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function collection(Collection $collection)
    {
        ...
        if (
            $data_import['id'] == 'Contoh ID Pelatihan' &&
            $data_import['kode'] == 'Contoh Kode Kelompok' &&
            $data_import['id_kelompok'] == 'Contoh ID Kelompok Pelatihan' &&
            $data_import['nama'] == 'Contoh Nama Pelatihan'
        ) {
        ...
        foreach ($collection as $value) {
            $industri = RefPelatihan::find($value['id']);
