...
class HonorTrainingImport implements ToCollection, SkipsEmptyRows, WithStartRow, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function collection(Collection $collection)
    {
        ...
        if (
            $data_import['id'] == 'Contoh ID Honor Training' &&
            $data_import['kode'] == 'Contoh Kode Honor Training' &&
            $data_import['jenis'] == 'Contoh Jenis Honor Training' &&
            $data_import['honor'] == 'Contoh Honor Honor Training' &&
            $data_import['satuan'] == 'Contoh Satuan Honor Training' &&
            $data_import['keterangan'] == 'Contoh Keterangan Honor Training'
        ) {
        ...
        foreach ($collection as $value) {
            $industri = RefHonorTraining::find($value['id']);
