...
class HonorAsesmenImport implements ToCollection, SkipsEmptyRows, WithStartRow, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function collection(Collection $collection)
    {
        ...
        if (
            $data_import['id'] == 'Contoh ID Honor Asesmen' &&
            $data_import['kode'] == 'Contoh Kode Honor Asesmen' &&
            $data_import['jenis'] == 'Contoh Jenis Honor Asesmen' &&
            $data_import['honor'] == 'Contoh Honor Honor Asesmen' &&
            $data_import['satuan'] == 'Contoh Satuan Honor Asesmen' &&
            $data_import['keterangan'] == 'Contoh Keterangan Honor Asesmen'
        ) {
        ...
        foreach ($collection as $value) {
            $industri = RefHonorAsesmen::find($value['id']);
