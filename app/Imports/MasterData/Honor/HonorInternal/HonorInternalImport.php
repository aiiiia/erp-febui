...
class HonorInternalImport implements ToCollection, SkipsEmptyRows, WithStartRow, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function collection(Collection $collection)
    {
        ...
        if (
            $data_import['id'] == 'Contoh ID Honor Internal' &&
            $data_import['kode'] == 'Contoh Kode Honor Internal' &&
            $data_import['jenis'] == 'Contoh Jenis Honor Internal' &&
            $data_import['honor'] == 'Contoh Honor Honor Internal' &&
            $data_import['satuan'] == 'Contoh Satuan Honor Internal' &&
            $data_import['keterangan'] == 'Contoh Keterangan Honor Internal'
        ) {
        ...
        foreach ($collection as $value) {
            $industri = RefHonorInternal::find($value['id']);
